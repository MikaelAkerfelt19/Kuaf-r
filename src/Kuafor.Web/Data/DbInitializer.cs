...
public static class DbInitializer
{
    ...
    private static async Task EnsureSeedDataAsync(ApplicationDbContext context)
    {
        ...
        {
            new Appointment { ServiceId = 1, StylistId = 1, BranchId = 1, CustomerId = 1, StartAt = DateTime.Today.AddDays(1).AddHours(14), EndAt = DateTime.Today.AddDays(1).AddHours(14).AddMinutes(30), Status = "Scheduled" },
            new Appointment { ServiceId = 2, StylistId = 2, BranchId = 1, CustomerId = 1, StartAt = DateTime.Today.AddDays(2).AddHours(16), EndAt = DateTime.Today.AddDays(2).AddHours(17), Status = "Scheduled" }
        };
